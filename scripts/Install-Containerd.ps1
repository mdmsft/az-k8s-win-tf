...
.EXAMPLE
PS> .\Install-Containerd.ps1 -ContainerDVersion 1.6.8 -CNIConfigPath "c:/etc/cni/net.d" -CNIBinPath "c:/opt/cni/bin"
#>
...
# Install helpers
Write-Output "Installing helpers"
...
DownloadAndExtractTarGz https://github.com/containerd/containerd/releases/download/v${ContainerDVersion}/containerd-${ContainerDVersion}-windows-amd64.tar.gz $global:ContainerDPath
Move-Item $global:ContainerDPath\bin\*.* $global:ContainerDPath
